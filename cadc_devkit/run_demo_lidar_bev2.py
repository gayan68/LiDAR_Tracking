...
#                                                                       #
#                                                                       #
# This is a modified version of "run_demo_lidar_bev.py" by cadc_devkit  #
# Original Git: https://github.com/mpitropov/cadc_devkit                #
#                                                                       #
#                                                                       #
#########################################################################
...
BASE = 'dataset/dataset/cadcd/2019_02_27/dataset/cadcd/2019_02_27/'
...
if DISTORTED:
  ...
  path_type = 'labeled' #'processed'


calib_path = "dataset/dataset/cadcd/2019_02_27/calib/";
img_path =  BASE + seq + "/" + path_type + "/image_0" + cam + "/data/" + format(frame, '010') + ".png";
annotations_path =  "../3d_ann.json";
...
def bev(s1,s2,f1,f2,frame,lidar_path,annotations_path):
    ...
    #aa = annotations_data[frame]['cuboids']
    #print(f"AAAAAAAAAAA: {aa[5]}")
    #sdg
    ...
    plt.xlim([0, x_max])
    plt.ylim([0, y_max])  
    fig.savefig(image_folder+"/bev_" + str(frame) + ".png", dpi=dpi, bbox_inches='tight', pad_inches=0.0)
...
def make_video_from_images(image_folder, output_video_file, fps=30):
    ...
    # Get the size (width, height) of the images
...
image_folder = 'images/3'
output_video_file = 'output_video3.mp4'
fps = 5  # Frames per second
output_gif_file = 'output3.gif'
duration = 300 

#make_video_from_images(image_folder, output_video_file, fps)
